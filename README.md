# Curso de aprendizaje profundo 2026-1, PCIC-UNAM
...
## Clonar rama
Este repositorio contiene el material de cursos anteriores y puede ser algo pesado clonarlo completamente. Para clonar únicamente la rama del curso 2026-1, debes hacerlo con el siguiente comando:

```
git clone --branch 2026-1 --single-branch https://github.com/gibranfp/CursoAprendizajeProfundo.git
```
